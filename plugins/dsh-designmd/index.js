/**
 * dsh-designmd bundle entry: registers the packaged
 * `skills/dsh-designmd/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-designmd
 */
...
const PROVIDER_NAME = 'dsh-designmd'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-designmd'
