/**
 * dsh-observability bundle entry: registers the packaged
 * `skills/dsh-observability/SKILL.md` bundle on `ctx.skills`.
...
const PROVIDER_NAME = 'dsh-observability'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-observability'
