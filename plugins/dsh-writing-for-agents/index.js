/**
 * dsh-writing-for-agents bundle entry: registers the packaged
 * `skills/dsh-writing-for-agents/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-writing-for-agents
 */
...
const PROVIDER_NAME = 'dsh-writing-for-agents'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-writing-for-agents'
