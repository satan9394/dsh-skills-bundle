/**
 * dsh-gitops bundle entry: registers the packaged
 * `skills/dsh-gitops/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-gitops
 */
...
const PROVIDER_NAME = 'dsh-gitops'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-gitops'
