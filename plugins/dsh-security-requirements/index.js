/**
 * dsh-security-requirements bundle entry: registers the packaged
 * `skills/dsh-security-requirements/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-security-requirements
 */
...
const PROVIDER_NAME = 'dsh-security-requirements'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-security-requirements'
