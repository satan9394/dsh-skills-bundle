/**
 * dsh-pptx-engineering bundle entry: registers the packaged
 * `skills/dsh-pptx-engineering/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-pptx-engineering
 */
...
const PROVIDER_NAME = 'dsh-pptx-engineering'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-pptx-engineering'
