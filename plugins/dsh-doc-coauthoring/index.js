/**
 * dsh-doc-coauthoring bundle entry: registers the packaged
 * `skills/dsh-doc-coauthoring/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-doc-coauthoring
 */
...
const PROVIDER_NAME = 'dsh-doc-coauthoring'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-doc-coauthoring'
