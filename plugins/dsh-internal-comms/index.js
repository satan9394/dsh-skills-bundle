/**
 * dsh-internal-comms bundle entry: registers the packaged
 * `skills/dsh-internal-comms/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-internal-comms
 */
...
const PROVIDER_NAME = 'dsh-internal-comms'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-internal-comms'
