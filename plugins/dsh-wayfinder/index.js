/**
 * dsh-wayfinder bundle entry: registers the packaged
 * `skills/dsh-wayfinder/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-wayfinder
 */
...
const PROVIDER_NAME = 'dsh-wayfinder'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-wayfinder'
