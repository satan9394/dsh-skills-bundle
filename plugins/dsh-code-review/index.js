/**
 * dsh-code-review bundle entry: registers the packaged
 * `skills/dsh-code-review/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-code-review
 */
...
const PROVIDER_NAME = 'dsh-code-review'
