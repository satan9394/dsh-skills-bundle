/**
 * dsh-data-quality bundle entry: registers the packaged
 * `skills/dsh-data-quality/SKILL.md` bundle on `ctx.skills`.
...
const PROVIDER_NAME = 'dsh-data-quality'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-data-quality'
