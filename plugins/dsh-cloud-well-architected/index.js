/**
 * dsh-cloud-well-architected bundle entry: registers the packaged
 * `skills/dsh-cloud-well-architected/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-cloud-well-architected
 */
...
const PROVIDER_NAME = 'dsh-cloud-well-architected'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-cloud-well-architected'
