/**
 * dsh-llm-finetuning bundle entry: registers the packaged
 * `skills/dsh-llm-finetuning/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-llm-finetuning
 */
...
const PROVIDER_NAME = 'dsh-llm-finetuning'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-llm-finetuning'
