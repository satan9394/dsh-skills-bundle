/**
 * dsh-recsys-pipeline bundle entry: registers the packaged
 * `skills/dsh-recsys-pipeline/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-recsys-pipeline
 */
...
const PROVIDER_NAME = 'dsh-recsys-pipeline'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-recsys-pipeline'
