/**
 * dsh-parallel-dev bundle entry: registers the packaged
 * `skills/dsh-parallel-dev/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-parallel-dev
 */
...
const PROVIDER_NAME = 'dsh-parallel-dev'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-parallel-dev'
