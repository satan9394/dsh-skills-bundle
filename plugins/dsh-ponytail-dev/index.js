/**
 * dsh-ponytail-dev bundle entry: registers the packaged
 * `skills/dsh-ponytail-dev/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-ponytail-dev
 */
...
const PROVIDER_NAME = 'dsh-ponytail-dev'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-ponytail-dev'
