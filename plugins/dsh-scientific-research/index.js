/**
 * dsh-scientific-research bundle entry: registers the packaged
 * `skills/dsh-scientific-research/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-scientific-research
 */
...
const PROVIDER_NAME = 'dsh-scientific-research'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-scientific-research'
