/**
 * dsh-context-engineering bundle entry: registers the packaged
 * `skills/dsh-context-engineering/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-context-engineering
 */
...
const PROVIDER_NAME = 'dsh-context-engineering'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-context-engineering'
