/**
 * dsh-api-scaffolding bundle entry: registers the packaged
 * `skills/dsh-api-scaffolding/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-api-scaffolding
 */
...
const PROVIDER_NAME = 'dsh-api-scaffolding'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-api-scaffolding'
