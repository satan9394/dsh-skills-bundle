/**
 * dsh-security-hardening bundle entry: registers the packaged
 * `skills/dsh-security-hardening/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-security-hardening
 */
...
const PROVIDER_NAME = 'dsh-security-hardening'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-security-hardening'
