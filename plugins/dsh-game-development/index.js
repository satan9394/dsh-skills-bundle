/**
 * dsh-game-development bundle entry: registers the packaged
 * `skills/dsh-game-development/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-game-development
 */
...
const PROVIDER_NAME = 'dsh-game-development'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-game-development'
