/**
 * dsh-source-driven bundle entry: registers the packaged
 * `skills/dsh-source-driven/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-source-driven
 */
...
const PROVIDER_NAME = 'dsh-source-driven'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-source-driven'
