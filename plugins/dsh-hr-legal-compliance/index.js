/**
 * dsh-hr-legal-compliance bundle entry: registers the packaged
 * `skills/dsh-hr-legal-compliance/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-hr-legal-compliance
 */
...
const PROVIDER_NAME = 'dsh-hr-legal-compliance'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-hr-legal-compliance'
