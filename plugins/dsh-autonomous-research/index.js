/**
 * dsh-autonomous-research bundle entry: registers the packaged
 * `skills/dsh-autonomous-research/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-autonomous-research
 */
...
const PROVIDER_NAME = 'dsh-autonomous-research'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-autonomous-research'
