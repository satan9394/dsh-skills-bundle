/**
 * dsh-content-distillation bundle entry: registers the packaged
 * `skills/dsh-content-distillation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-content-distillation
 */
...
const PROVIDER_NAME = 'dsh-content-distillation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-content-distillation'
