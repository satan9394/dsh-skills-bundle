/**
 * dsh-geo-seo bundle entry: registers the packaged
 * `skills/dsh-geo-seo/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-geo-seo
 */
...
const PROVIDER_NAME = 'dsh-geo-seo'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-geo-seo'
