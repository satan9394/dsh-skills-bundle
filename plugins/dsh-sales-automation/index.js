/**
 * dsh-sales-automation bundle entry: registers the packaged
 * `skills/dsh-sales-automation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-sales-automation
 */
...
const PROVIDER_NAME = 'dsh-sales-automation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-sales-automation'
