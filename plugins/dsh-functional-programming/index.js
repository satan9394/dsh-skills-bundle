/**
 * dsh-functional-programming bundle entry: registers the packaged
 * `skills/dsh-functional-programming/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-functional-programming
 */
...
const PROVIDER_NAME = 'dsh-functional-programming'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-functional-programming'
