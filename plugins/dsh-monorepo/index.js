/**
 * dsh-monorepo bundle entry: registers the packaged
 * `skills/dsh-monorepo/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-monorepo
 */
...
const PROVIDER_NAME = 'dsh-monorepo'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-monorepo'
