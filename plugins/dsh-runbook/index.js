/**
 * dsh-runbook bundle entry: registers the packaged
 * `skills/dsh-runbook/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-runbook
 */
...
const PROVIDER_NAME = 'dsh-runbook'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-runbook'
