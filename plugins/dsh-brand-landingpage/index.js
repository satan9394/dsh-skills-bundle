/**
 * dsh-brand-landingpage bundle entry: registers the packaged
 * `skills/dsh-brand-landingpage/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-brand-landingpage
 */
...
const PROVIDER_NAME = 'dsh-brand-landingpage'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-brand-landingpage'
