/**
 * dsh-performance bundle entry: registers the packaged
 * `skills/dsh-performance/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-performance
 */
...
const PROVIDER_NAME = 'dsh-performance'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-performance'
