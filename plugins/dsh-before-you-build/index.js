/**
 * dsh-before-you-build bundle entry: registers the packaged
 * `skills/dsh-before-you-build/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-before-you-build
 */
...
const PROVIDER_NAME = 'dsh-before-you-build'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-before-you-build'
