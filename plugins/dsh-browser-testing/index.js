/**
 * dsh-browser-testing bundle entry: registers the packaged
 * `skills/dsh-browser-testing/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-browser-testing
 */
...
const PROVIDER_NAME = 'dsh-browser-testing'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-browser-testing'
