/**
 * dsh-content-marketing bundle entry: registers the packaged
 * `skills/dsh-content-marketing/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-content-marketing
 */
...
const PROVIDER_NAME = 'dsh-content-marketing'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-content-marketing'
