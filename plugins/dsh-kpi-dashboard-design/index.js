/**
 * dsh-kpi-dashboard-design bundle entry: registers the packaged
 * `skills/dsh-kpi-dashboard-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-kpi-dashboard-design
 */
...
const PROVIDER_NAME = 'dsh-kpi-dashboard-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-kpi-dashboard-design'
