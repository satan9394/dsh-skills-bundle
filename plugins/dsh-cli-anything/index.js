/**
 * dsh-cli-anything bundle entry: registers the packaged
 * `skills/dsh-cli-anything/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-cli-anything
 */
...
const PROVIDER_NAME = 'dsh-cli-anything'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-cli-anything'
