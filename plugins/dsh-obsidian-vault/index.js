/**
 * dsh-obsidian-vault bundle entry: registers the packaged
 * `skills/dsh-obsidian-vault/SKILL.md` bundle on `ctx.skills`.
...
const PROVIDER_NAME = 'dsh-obsidian-vault'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-obsidian-vault'
