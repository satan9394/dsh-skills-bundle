/**
 * dsh-swarm-prediction bundle entry: registers the packaged
 * `skills/dsh-swarm-prediction/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-swarm-prediction
 */
...
const PROVIDER_NAME = 'dsh-swarm-prediction'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-swarm-prediction'
