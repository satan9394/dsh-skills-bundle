/**
 * dsh-error-handling bundle entry: registers the packaged
 * `skills/dsh-error-handling/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-error-handling
 */
...
const PROVIDER_NAME = 'dsh-error-handling'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-error-handling'
