/**
 * dsh-theme-factory bundle entry: registers the packaged
 * `skills/dsh-theme-factory/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-theme-factory
 */
...
const PROVIDER_NAME = 'dsh-theme-factory'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-theme-factory'
