/**
 * dsh-data-engineering bundle entry: registers the packaged
 * `skills/dsh-data-engineering/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-data-engineering
 */
...
const PROVIDER_NAME = 'dsh-data-engineering'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-data-engineering'
