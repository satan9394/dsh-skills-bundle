/**
 * dsh-llm-api-integration bundle entry: registers the packaged
 * `skills/dsh-llm-api-integration/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-llm-api-integration
 */
...
const PROVIDER_NAME = 'dsh-llm-api-integration'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-llm-api-integration'
