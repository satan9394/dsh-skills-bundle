/**
 * dsh-debug-recovery bundle entry: registers the packaged
 * `skills/dsh-debug-recovery/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-debug-recovery
 */
...
const PROVIDER_NAME = 'dsh-debug-recovery'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-debug-recovery'
