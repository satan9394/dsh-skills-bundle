/**
 * dsh-persistent-memory bundle entry: registers the packaged
 * `skills/dsh-persistent-memory/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-persistent-memory
 */
...
const PROVIDER_NAME = 'dsh-persistent-memory'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-persistent-memory'
