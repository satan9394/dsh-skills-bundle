/**
 * dsh-file-conversion bundle entry: registers the packaged
 * `skills/dsh-file-conversion/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-file-conversion
 */
...
const PROVIDER_NAME = 'dsh-file-conversion'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-file-conversion'
