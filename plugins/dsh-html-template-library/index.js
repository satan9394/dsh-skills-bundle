/**
 * dsh-html-template-library bundle entry: registers the packaged
 * `skills/dsh-html-template-library/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-html-template-library
 */
...
const PROVIDER_NAME = 'dsh-html-template-library'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-html-template-library'
