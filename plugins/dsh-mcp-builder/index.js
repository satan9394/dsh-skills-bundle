/**
 * dsh-mcp-builder bundle entry: registers the packaged
 * `skills/dsh-mcp-builder/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-mcp-builder
 */
...
const PROVIDER_NAME = 'dsh-mcp-builder'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-mcp-builder'
