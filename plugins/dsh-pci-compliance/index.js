/**
 * dsh-pci-compliance bundle entry: registers the packaged
 * `skills/dsh-pci-compliance/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-pci-compliance
 */
...
const PROVIDER_NAME = 'dsh-pci-compliance'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-pci-compliance'
