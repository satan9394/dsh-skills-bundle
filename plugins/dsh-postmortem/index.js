/**
 * dsh-postmortem bundle entry: registers the packaged
 * `skills/dsh-postmortem/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-postmortem
 */
...
const PROVIDER_NAME = 'dsh-postmortem'
