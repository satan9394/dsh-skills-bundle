/**
 * dsh-office-cli bundle entry: registers the packaged
 * `skills/dsh-office-cli/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-office-cli
 */
...
const PROVIDER_NAME = 'dsh-office-cli'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-office-cli'
