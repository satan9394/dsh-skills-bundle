/**
 * dsh-brand-guidelines bundle entry: registers the packaged
 * `skills/dsh-brand-guidelines/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-brand-guidelines
 */
...
const PROVIDER_NAME = 'dsh-brand-guidelines'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-brand-guidelines'
