/**
 * dsh-pdf-processing bundle entry: registers the packaged
 * `skills/dsh-pdf-processing/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-pdf-processing
 */
...
const PROVIDER_NAME = 'dsh-pdf-processing'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-pdf-processing'
