/**
 * dsh-doubt-driven-dev bundle entry: registers the packaged
 * `skills/dsh-doubt-driven-dev/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-doubt-driven-dev
 */
...
const PROVIDER_NAME = 'dsh-doubt-driven-dev'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-doubt-driven-dev'
