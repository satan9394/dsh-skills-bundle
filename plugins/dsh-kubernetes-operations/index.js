/**
 * dsh-kubernetes-operations bundle entry: registers the packaged
 * `skills/dsh-kubernetes-operations/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-kubernetes-operations
 */
...
const PROVIDER_NAME = 'dsh-kubernetes-operations'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-kubernetes-operations'
