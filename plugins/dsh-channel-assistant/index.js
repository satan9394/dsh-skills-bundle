/**
 * dsh-channel-assistant bundle entry: registers the packaged
 * `skills/dsh-channel-assistant/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-channel-assistant
 */
...
const PROVIDER_NAME = 'dsh-channel-assistant'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-channel-assistant'
