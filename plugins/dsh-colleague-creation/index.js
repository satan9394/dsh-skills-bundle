/**
 * dsh-colleague-creation bundle entry: registers the packaged
 * `skills/dsh-colleague-creation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-colleague-creation
 */
...
const PROVIDER_NAME = 'dsh-colleague-creation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-colleague-creation'
