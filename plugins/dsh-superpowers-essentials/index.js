/**
 * dsh-superpowers-essentials bundle entry: registers the packaged
 * `skills/superpowers-essentials/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-superpowers-essentials
 */
...
const PROVIDER_NAME = 'dsh-superpowers-essentials'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-superpowers-essentials'
