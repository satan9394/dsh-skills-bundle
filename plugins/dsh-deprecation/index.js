/**
 * dsh-deprecation bundle entry: registers the packaged
 * `skills/dsh-deprecation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-deprecation
 */
...
const PROVIDER_NAME = 'dsh-deprecation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-deprecation'
