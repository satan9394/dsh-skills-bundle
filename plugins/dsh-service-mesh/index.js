/**
 * dsh-service-mesh bundle entry: registers the packaged
 * `skills/dsh-service-mesh/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-service-mesh
 */
...
const PROVIDER_NAME = 'dsh-service-mesh'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-service-mesh'
