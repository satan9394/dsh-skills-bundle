/**
 * dsh-threat-modeling bundle entry: registers the packaged
 * `skills/dsh-threat-modeling/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-threat-modeling
 */
...
const PROVIDER_NAME = 'dsh-threat-modeling'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-threat-modeling'
