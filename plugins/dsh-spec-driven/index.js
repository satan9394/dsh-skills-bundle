/**
 * dsh-spec-driven bundle entry: registers the packaged
 * `skills/dsh-spec-driven/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-spec-driven
 */
...
const PROVIDER_NAME = 'dsh-spec-driven'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-spec-driven'
