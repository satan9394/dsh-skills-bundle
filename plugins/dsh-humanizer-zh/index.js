/**
 * dsh-humanizer-zh bundle entry: registers the packaged
 * `skills/humanizer-zh/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-humanizer-zh
 */
...
const PROVIDER_NAME = 'dsh-humanizer-zh'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-humanizer-zh'
