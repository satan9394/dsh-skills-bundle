/**
 * dsh-merge-conflicts bundle entry: registers the packaged
 * `skills/dsh-merge-conflicts/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-merge-conflicts
 */
...
const PROVIDER_NAME = 'dsh-merge-conflicts'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-merge-conflicts'
