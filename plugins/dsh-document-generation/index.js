/**
 * dsh-document-generation bundle entry: registers the packaged
 * `skills/dsh-document-generation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-document-generation
 */
...
const PROVIDER_NAME = 'dsh-document-generation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-document-generation'
