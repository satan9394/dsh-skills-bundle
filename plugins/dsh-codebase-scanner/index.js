/**
 * dsh-codebase-scanner bundle entry: registers the packaged
 * `skills/dsh-codebase-scanner/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-codebase-scanner
 */
...
const PROVIDER_NAME = 'dsh-codebase-scanner'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-codebase-scanner'
