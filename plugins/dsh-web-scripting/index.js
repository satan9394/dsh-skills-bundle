/**
 * dsh-web-scripting bundle entry: registers the packaged
 * `skills/dsh-web-scripting/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-web-scripting
 */
...
const PROVIDER_NAME = 'dsh-web-scripting'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-web-scripting'
