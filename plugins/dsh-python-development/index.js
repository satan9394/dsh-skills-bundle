/**
 * dsh-python-development bundle entry: registers the packaged
 * `skills/dsh-python-development/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-python-development
 */
...
const PROVIDER_NAME = 'dsh-python-development'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-python-development'
