/**
 * dsh-hybrid-cloud bundle entry: registers the packaged
 * `skills/dsh-hybrid-cloud/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-hybrid-cloud
 */
...
const PROVIDER_NAME = 'dsh-hybrid-cloud'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-hybrid-cloud'
