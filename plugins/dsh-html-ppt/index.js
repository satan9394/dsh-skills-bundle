/**
 * dsh-html-ppt bundle entry: registers the packaged
 * `skills/dsh-html-ppt/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-html-ppt
 */
...
const PROVIDER_NAME = 'dsh-html-ppt'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-html-ppt'
