/**
 * dsh-workflow-loop bundle entry: registers the packaged
 * `skills/dsh-workflow-loop/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-workflow-loop
 */
...
const PROVIDER_NAME = 'dsh-workflow-loop'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-workflow-loop'
