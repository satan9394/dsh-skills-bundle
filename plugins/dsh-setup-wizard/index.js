/**
 * dsh-setup-wizard bundle entry: registers the packaged
 * `skills/dsh-setup-wizard/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-setup-wizard
 */
...
const PROVIDER_NAME = 'dsh-setup-wizard'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-setup-wizard'
