/**
 * dsh-contract-review bundle entry: registers the packaged
 * `skills/contract-review/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-contract-review
 */
...
const PROVIDER_NAME = 'dsh-contract-review'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-contract-review'
