/**
 * dsh-grill-me bundle entry: registers the packaged `skills/<name>/SKILL.md`
 * bundle on `ctx.skills`, so every session sees the grill-me skill in its
 * skill catalog. Frontmatter is parsed with the `yaml` library, matching the
 * official skill providers.
 * @module dsh-grill-me
 */
...
/** Same rank as packaged dsh skill providers (BUNDLED_SKILL_RANK). */
const BUNDLED_SKILL_RANK = 600
const SKILL_NAME = /^[a-z0-9]+(?:-[a-z0-9]+)*$/
const PROVIDER_NAME = 'dsh-grill-me'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-grill-me'
