/**
 * dsh-sast-security bundle entry: registers the packaged
 * `skills/dsh-sast-security/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-sast-security
 */
...
const PROVIDER_NAME = 'dsh-sast-security'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-sast-security'
