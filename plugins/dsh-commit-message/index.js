/**
 * dsh-commit-message bundle entry: registers the packaged
 * `skills/dsh-commit-message/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-commit-message
 */
...
const PROVIDER_NAME = 'dsh-commit-message'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-commit-message'
