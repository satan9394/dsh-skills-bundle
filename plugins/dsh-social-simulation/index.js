/**
 * dsh-social-simulation bundle entry: registers the packaged
 * `skills/dsh-social-simulation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-social-simulation
 */
...
const PROVIDER_NAME = 'dsh-social-simulation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-social-simulation'
