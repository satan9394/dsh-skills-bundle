/**
 * dsh-desktop-agent-gui bundle entry: registers the packaged
 * `skills/dsh-desktop-agent-gui/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-desktop-agent-gui
 */
...
const PROVIDER_NAME = 'dsh-desktop-agent-gui'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-desktop-agent-gui'
