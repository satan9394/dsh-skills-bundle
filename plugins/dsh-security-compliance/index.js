/**
 * dsh-security-compliance bundle entry: registers the packaged
 * `skills/dsh-security-compliance/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-security-compliance
 */
...
const PROVIDER_NAME = 'dsh-security-compliance'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-security-compliance'
