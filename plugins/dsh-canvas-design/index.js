/**
 * dsh-canvas-design bundle entry: registers the packaged
 * `skills/dsh-canvas-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-canvas-design
 */
...
const PROVIDER_NAME = 'dsh-canvas-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-canvas-design'
