/**
 * dsh-startup-business-analyst bundle entry: registers the packaged
 * `skills/dsh-startup-business-analyst/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-startup-business-analyst
 */
...
const PROVIDER_NAME = 'dsh-startup-business-analyst'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-startup-business-analyst'
