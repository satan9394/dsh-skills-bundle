/**
 * dsh-prompt-engineering bundle entry: registers the packaged
 * `skills/dsh-prompt-engineering/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-prompt-engineering
 */
...
const PROVIDER_NAME = 'dsh-prompt-engineering'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-prompt-engineering'
