/**
 * dsh-webapp-testing bundle entry: registers the packaged
 * `skills/dsh-webapp-testing/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-webapp-testing
 */
...
const PROVIDER_NAME = 'dsh-webapp-testing'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-webapp-testing'
