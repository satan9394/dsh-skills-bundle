/**
 * dsh-parallel-agent-ade bundle entry: registers the packaged
 * `skills/dsh-parallel-agent-ade/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-parallel-agent-ade
 */
...
const PROVIDER_NAME = 'dsh-parallel-agent-ade'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-parallel-agent-ade'
