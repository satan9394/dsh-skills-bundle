/**
 * dsh-changelog bundle entry: registers the packaged
 * `skills/dsh-changelog/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-changelog
 */
...
const PROVIDER_NAME = 'dsh-changelog'
