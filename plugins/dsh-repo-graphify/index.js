/**
 * dsh-repo-graphify bundle entry: registers the packaged
 * `skills/dsh-repo-graphify/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-repo-graphify
 */
...
const PROVIDER_NAME = 'dsh-repo-graphify'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-repo-graphify'
