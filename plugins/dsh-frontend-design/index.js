/**
 * dsh-frontend-design bundle entry: registers the packaged
 * `skills/frontend-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-frontend-design
 */
...
const PROVIDER_NAME = 'dsh-frontend-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-frontend-design'
