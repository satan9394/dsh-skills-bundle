/**
 * dsh-dotnet-backend bundle entry: registers the packaged
 * `skills/dsh-dotnet-backend/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-dotnet-backend
 */
...
const PROVIDER_NAME = 'dsh-dotnet-backend'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-dotnet-backend'
