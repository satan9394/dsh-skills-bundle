/**
 * dsh-track-driven-dev bundle entry: registers the packaged
 * `skills/dsh-track-driven-dev/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-track-driven-dev
 */
...
const PROVIDER_NAME = 'dsh-track-driven-dev'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-track-driven-dev'
