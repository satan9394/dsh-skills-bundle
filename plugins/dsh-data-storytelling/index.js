/**
 * dsh-data-storytelling bundle entry: registers the packaged
 * `skills/dsh-data-storytelling/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-data-storytelling
 */
...
const PROVIDER_NAME = 'dsh-data-storytelling'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-data-storytelling'
