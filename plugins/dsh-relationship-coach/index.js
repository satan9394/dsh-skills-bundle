/**
 * dsh-relationship-coach bundle entry: registers the packaged
 * `skills/dsh-relationship-coach/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-relationship-coach
 */
...
const PROVIDER_NAME = 'dsh-relationship-coach'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-relationship-coach'
