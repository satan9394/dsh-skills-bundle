/**
 * dsh-self-improving-agent bundle entry: registers the packaged
 * `skills/dsh-self-improving-agent/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-self-improving-agent
 */
...
const PROVIDER_NAME = 'dsh-self-improving-agent'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-self-improving-agent'
