/**
 * dsh-taste-review bundle entry: registers the packaged
 * `skills/dsh-taste-review/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-taste-review
 */
...
const PROVIDER_NAME = 'dsh-taste-review'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-taste-review'
