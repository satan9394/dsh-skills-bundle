/**
 * dsh-api-documentation bundle entry: registers the packaged
 * `skills/dsh-api-documentation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-api-documentation
 */
...
const PROVIDER_NAME = 'dsh-api-documentation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-api-documentation'
