/**
 * dsh-e2e-testing bundle entry: registers the packaged
 * `skills/dsh-e2e-testing/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-e2e-testing
 */
...
const PROVIDER_NAME = 'dsh-e2e-testing'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-e2e-testing'
