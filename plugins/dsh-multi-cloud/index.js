/**
 * dsh-multi-cloud bundle entry: registers the packaged
 * `skills/dsh-multi-cloud/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-multi-cloud
 */
...
const PROVIDER_NAME = 'dsh-multi-cloud'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-multi-cloud'
