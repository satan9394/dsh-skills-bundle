/**
 * dsh-gif-creator bundle entry: registers the packaged
 * `skills/dsh-gif-creator/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-gif-creator
 */
...
const PROVIDER_NAME = 'dsh-gif-creator'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-gif-creator'
