/**
 * dsh-career-ops bundle entry: registers the packaged
 * `skills/career-ops/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-career-ops
 */
...
const PROVIDER_NAME = 'dsh-career-ops'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-career-ops'
