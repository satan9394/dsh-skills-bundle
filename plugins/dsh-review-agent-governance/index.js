/**
 * dsh-review-agent-governance bundle entry: registers the packaged
 * `skills/dsh-review-agent-governance/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-review-agent-governance
 */
...
const PROVIDER_NAME = 'dsh-review-agent-governance'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-review-agent-governance'
