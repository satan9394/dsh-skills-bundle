/**
 * dsh-ai-image-design bundle entry: registers the packaged
 * `skills/dsh-ai-image-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-ai-image-design
 */
...
const PROVIDER_NAME = 'dsh-ai-image-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-ai-image-design'
