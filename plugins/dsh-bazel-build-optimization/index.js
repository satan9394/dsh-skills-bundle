/**
 * dsh-bazel-build-optimization bundle entry: registers the packaged
 * `skills/dsh-bazel-build-optimization/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-bazel-build-optimization
 */
...
const PROVIDER_NAME = 'dsh-bazel-build-optimization'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-bazel-build-optimization'
