/**
 * dsh-model-gateway bundle entry: registers the packaged
 * `skills/dsh-model-gateway/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-model-gateway
 */
...
const PROVIDER_NAME = 'dsh-model-gateway'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-model-gateway'
