/**
 * dsh-full-stack-orchestration bundle entry: registers the packaged
 * `skills/dsh-full-stack-orchestration/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-full-stack-orchestration
 */
...
const PROVIDER_NAME = 'dsh-full-stack-orchestration'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-full-stack-orchestration'
