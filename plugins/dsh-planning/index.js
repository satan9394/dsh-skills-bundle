/**
 * dsh-planning bundle entry: registers the packaged
 * `skills/dsh-planning/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-planning
 */
...
const PROVIDER_NAME = 'dsh-planning'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-planning'
