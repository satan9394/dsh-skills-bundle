/**
 * dsh-doc-compiled-skills bundle entry: registers the packaged
 * `skills/dsh-doc-compiled-skills/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-doc-compiled-skills
 */
...
const PROVIDER_NAME = 'dsh-doc-compiled-skills'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-doc-compiled-skills'
