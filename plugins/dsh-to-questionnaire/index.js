/**
 * dsh-to-questionnaire bundle entry: registers the packaged
 * `skills/dsh-to-questionnaire/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-to-questionnaire
 */
...
const PROVIDER_NAME = 'dsh-to-questionnaire'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-to-questionnaire'
