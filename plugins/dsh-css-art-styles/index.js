/**
 * dsh-css-art-styles bundle entry: registers the packaged
 * `skills/dsh-css-art-styles/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-css-art-styles
 */
...
const PROVIDER_NAME = 'dsh-css-art-styles'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-css-art-styles'
