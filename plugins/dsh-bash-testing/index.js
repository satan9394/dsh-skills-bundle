/**
 * dsh-bash-testing bundle entry: registers the packaged
 * `skills/dsh-bash-testing/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-bash-testing
 */
...
const PROVIDER_NAME = 'dsh-bash-testing'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-bash-testing'
