/**
 * dsh-reverse-engineering bundle entry: registers the packaged
 * `skills/dsh-reverse-engineering/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-reverse-engineering
 */
...
const PROVIDER_NAME = 'dsh-reverse-engineering'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-reverse-engineering'
