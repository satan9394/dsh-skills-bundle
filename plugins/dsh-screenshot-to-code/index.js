/**
 * dsh-screenshot-to-code bundle entry: registers the packaged
 * `skills/dsh-screenshot-to-code/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-screenshot-to-code
 */
...
const PROVIDER_NAME = 'dsh-screenshot-to-code'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-screenshot-to-code'
