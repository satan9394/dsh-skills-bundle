/**
 * dsh-harness-os bundle entry: registers the packaged
 * `skills/dsh-harness-os/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-harness-os
 */
...
const PROVIDER_NAME = 'dsh-harness-os'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-harness-os'
