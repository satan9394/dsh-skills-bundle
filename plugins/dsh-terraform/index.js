/**
 * dsh-terraform bundle entry: registers the packaged
 * `skills/dsh-terraform/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-terraform
 */
...
const PROVIDER_NAME = 'dsh-terraform'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-terraform'
