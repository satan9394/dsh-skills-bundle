/**
 * dsh-codebase-design bundle entry: registers the packaged
 * `skills/dsh-codebase-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-codebase-design
 */
...
const PROVIDER_NAME = 'dsh-codebase-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-codebase-design'
