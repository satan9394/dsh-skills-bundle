/**
 * dsh-writing-fragments bundle entry: registers the packaged
 * `skills/dsh-writing-fragments/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-writing-fragments
 */
...
const PROVIDER_NAME = 'dsh-writing-fragments'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-writing-fragments'
