/**
 * dsh-caveman-speak bundle entry: registers the packaged
 * `skills/dsh-caveman-speak/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-caveman-speak
 */
...
const PROVIDER_NAME = 'dsh-caveman-speak'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-caveman-speak'
