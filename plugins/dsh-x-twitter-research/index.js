/**
 * dsh-x-twitter-research bundle entry: registers the packaged
 * `skills/dsh-x-twitter-research/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-x-twitter-research
 */
...
const PROVIDER_NAME = 'dsh-x-twitter-research'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-x-twitter-research'
