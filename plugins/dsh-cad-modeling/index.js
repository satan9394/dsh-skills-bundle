/**
 * dsh-cad-modeling bundle entry: registers the packaged
 * `skills/dsh-cad-modeling/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-cad-modeling
 */
...
const PROVIDER_NAME = 'dsh-cad-modeling'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-cad-modeling'
