/**
 * dsh-vector-search bundle entry: registers the packaged
 * `skills/dsh-vector-search/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-vector-search
 */
...
const PROVIDER_NAME = 'dsh-vector-search'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-vector-search'
