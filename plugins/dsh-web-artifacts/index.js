/**
 * dsh-web-artifacts bundle entry: registers the packaged
 * `skills/dsh-web-artifacts/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-web-artifacts
 */
...
const PROVIDER_NAME = 'dsh-web-artifacts'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-web-artifacts'
