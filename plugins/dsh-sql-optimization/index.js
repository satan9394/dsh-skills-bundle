/**
 * dsh-sql-optimization bundle entry: registers the packaged
 * `skills/dsh-sql-optimization/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-sql-optimization
 */
...
const PROVIDER_NAME = 'dsh-sql-optimization'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-sql-optimization'
