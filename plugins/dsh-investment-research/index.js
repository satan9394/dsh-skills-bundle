/**
 * dsh-investment-research bundle entry: registers the packaged
 * `skills/dsh-investment-research/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-investment-research
 */
...
const PROVIDER_NAME = 'dsh-investment-research'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-investment-research'
