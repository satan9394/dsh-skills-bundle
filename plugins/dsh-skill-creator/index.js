/**
 * dsh-skill-creator bundle entry: registers the packaged
 * `skills/skill-creator/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-skill-creator
 */
...
const PROVIDER_NAME = 'dsh-skill-creator'
