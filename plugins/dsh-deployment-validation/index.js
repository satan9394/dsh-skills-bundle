/**
 * dsh-deployment-validation bundle entry: registers the packaged
 * `skills/dsh-deployment-validation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-deployment-validation
 */
...
const PROVIDER_NAME = 'dsh-deployment-validation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-deployment-validation'
