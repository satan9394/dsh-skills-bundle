/**
 * dsh-brand-design bundle entry: registers the packaged
 * `skills/dsh-brand-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-brand-design
 */
...
const PROVIDER_NAME = 'dsh-brand-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-brand-design'
