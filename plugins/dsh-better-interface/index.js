/**
 * dsh-better-interface bundle entry: registers the packaged
 * `skills/dsh-better-interface/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-better-interface
 */
...
const PROVIDER_NAME = 'dsh-better-interface'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-better-interface'
