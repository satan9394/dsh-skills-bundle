/**
 * dsh-marketing-growth bundle entry: registers the packaged
 * `skills/dsh-marketing-growth/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-marketing-growth
 */
...
const PROVIDER_NAME = 'dsh-marketing-growth'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-marketing-growth'
