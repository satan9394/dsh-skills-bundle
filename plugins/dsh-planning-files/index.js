/**
 * dsh-planning-files bundle entry: registers the packaged
 * `skills/dsh-planning-files/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-planning-files
 */
...
const PROVIDER_NAME = 'dsh-planning-files'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-planning-files'
