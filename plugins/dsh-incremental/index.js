/**
 * dsh-incremental bundle entry: registers the packaged
 * `skills/dsh-incremental/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-incremental
 */
...
const PROVIDER_NAME = 'dsh-incremental'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-incremental'
