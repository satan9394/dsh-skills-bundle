/**
 * dsh-personal-content-discovery bundle entry: registers the packaged
 * `skills/dsh-personal-content-discovery/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-personal-content-discovery
 */
...
const PROVIDER_NAME = 'dsh-personal-content-discovery'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-personal-content-discovery'
