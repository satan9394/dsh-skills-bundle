/**
 * dsh-adhd-friendly bundle entry: registers the packaged
 * `skills/dsh-adhd-friendly/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-adhd-friendly
 */
...
const PROVIDER_NAME = 'dsh-adhd-friendly'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-adhd-friendly'
