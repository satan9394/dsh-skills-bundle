/**
 * dsh-bash-scripting bundle entry: registers the packaged
 * `skills/dsh-bash-scripting/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-bash-scripting
 */
...
const PROVIDER_NAME = 'dsh-bash-scripting'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-bash-scripting'
