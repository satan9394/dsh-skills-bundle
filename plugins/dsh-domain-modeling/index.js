/**
 * dsh-domain-modeling bundle entry: registers the packaged
 * `skills/dsh-domain-modeling/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-domain-modeling
 */
...
const PROVIDER_NAME = 'dsh-domain-modeling'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-domain-modeling'
