/**
 * dsh-docs-adr bundle entry: registers the packaged
 * `skills/dsh-docs-adr/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-docs-adr
 */
...
const PROVIDER_NAME = 'dsh-docs-adr'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-docs-adr'
