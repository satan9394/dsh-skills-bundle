/**
 * dsh-meeting-minutes bundle entry: registers the packaged
 * `skills/meeting-minutes/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-meeting-minutes
 */
...
const PROVIDER_NAME = 'dsh-meeting-minutes'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-meeting-minutes'
