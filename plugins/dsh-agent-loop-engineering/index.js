/**
 * dsh-agent-loop-engineering bundle entry: registers the packaged
 * `skills/dsh-agent-loop-engineering/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-agent-loop-engineering
 */
...
const PROVIDER_NAME = 'dsh-agent-loop-engineering'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-agent-loop-engineering'
