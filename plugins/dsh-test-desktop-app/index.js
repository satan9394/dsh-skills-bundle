/**
 * dsh-test-desktop-app bundle entry: registers the packaged
 * `skills/dsh-test-desktop-app/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-test-desktop-app
 */
...
const PROVIDER_NAME = 'dsh-test-desktop-app'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-test-desktop-app'
