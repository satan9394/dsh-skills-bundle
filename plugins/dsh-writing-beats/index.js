/**
 * dsh-writing-beats bundle entry: registers the packaged
 * `skills/dsh-writing-beats/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-writing-beats
 */
...
const PROVIDER_NAME = 'dsh-writing-beats'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-writing-beats'
