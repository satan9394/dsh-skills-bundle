/**
 * dsh-skill-seekers bundle entry: registers the packaged
 * `skills/dsh-skill-seekers/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-skill-seekers
 */
...
const PROVIDER_NAME = 'dsh-skill-seekers'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-skill-seekers'
