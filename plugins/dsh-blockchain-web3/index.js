/**
 * dsh-blockchain-web3 bundle entry: registers the packaged
 * `skills/dsh-blockchain-web3/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-blockchain-web3
 */
...
const PROVIDER_NAME = 'dsh-blockchain-web3'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-blockchain-web3'
