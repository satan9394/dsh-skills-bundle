/**
 * dsh-prototype bundle entry: registers the packaged
 * `skills/dsh-prototype/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-prototype
 */
...
const PROVIDER_NAME = 'dsh-prototype'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-prototype'
