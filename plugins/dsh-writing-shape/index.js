/**
 * dsh-writing-shape bundle entry: registers the packaged
 * `skills/dsh-writing-shape/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-writing-shape
 */
...
const PROVIDER_NAME = 'dsh-writing-shape'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-writing-shape'
