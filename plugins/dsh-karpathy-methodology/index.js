/**
 * dsh-karpathy-methodology bundle entry: registers the packaged
 * `skills/karpathy-methodology/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-karpathy-methodology
 */
...
const PROVIDER_NAME = 'dsh-karpathy-methodology'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-karpathy-methodology'
