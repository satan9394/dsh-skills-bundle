/**
 * dsh-database-design bundle entry: registers the packaged
 * `skills/dsh-database-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-database-design
 */
...
const PROVIDER_NAME = 'dsh-database-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-database-design'
