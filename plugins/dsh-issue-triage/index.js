/**
 * dsh-issue-triage bundle entry: registers the packaged
 * `skills/dsh-issue-triage/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-issue-triage
 */
...
const PROVIDER_NAME = 'dsh-issue-triage'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-issue-triage'
