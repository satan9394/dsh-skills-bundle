/**
 * dsh-web-clone bundle entry: registers the packaged
 * `skills/dsh-web-clone/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-web-clone
 */
...
const PROVIDER_NAME = 'dsh-web-clone'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-web-clone'
