/**
 * dsh-frontend-slides bundle entry: registers the packaged
 * `skills/dsh-frontend-slides/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-frontend-slides
 */
...
const PROVIDER_NAME = 'dsh-frontend-slides'
