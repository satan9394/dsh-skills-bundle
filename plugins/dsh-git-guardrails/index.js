/**
 * dsh-git-guardrails bundle entry: registers the packaged
 * `skills/dsh-git-guardrails/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-git-guardrails
 */
...
const PROVIDER_NAME = 'dsh-git-guardrails'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-git-guardrails'
