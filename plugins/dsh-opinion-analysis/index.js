/**
 * dsh-opinion-analysis bundle entry: registers the packaged
 * `skills/dsh-opinion-analysis/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-opinion-analysis
 */
...
const PROVIDER_NAME = 'dsh-opinion-analysis'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-opinion-analysis'
