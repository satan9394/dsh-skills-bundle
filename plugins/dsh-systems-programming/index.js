/**
 * dsh-systems-programming bundle entry: registers the packaged
 * `skills/dsh-systems-programming/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-systems-programming
 */
...
const PROVIDER_NAME = 'dsh-systems-programming'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-systems-programming'
