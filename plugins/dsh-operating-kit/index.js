/**
 * dsh-operating-kit bundle entry: registers the packaged
 * `skills/dsh-operating-kit/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-operating-kit
 */
...
const PROVIDER_NAME = 'dsh-operating-kit'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-operating-kit'
