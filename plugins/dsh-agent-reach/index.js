/**
 * dsh-agent-reach bundle entry: registers the packaged
 * `skills/dsh-agent-reach/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-agent-reach
 */
...
const PROVIDER_NAME = 'dsh-agent-reach'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-agent-reach'
