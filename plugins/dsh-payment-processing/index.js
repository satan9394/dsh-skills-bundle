/**
 * dsh-payment-processing bundle entry: registers the packaged
 * `skills/dsh-payment-processing/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-payment-processing
 */
...
const PROVIDER_NAME = 'dsh-payment-processing'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-payment-processing'
