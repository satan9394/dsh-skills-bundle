/**
 * dsh-shipping bundle entry: registers the packaged
 * `skills/dsh-shipping/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-shipping
 */
...
const PROVIDER_NAME = 'dsh-shipping'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-shipping'
