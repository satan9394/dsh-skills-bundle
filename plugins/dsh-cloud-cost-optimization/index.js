/**
 * dsh-cloud-cost-optimization bundle entry: registers the packaged
 * `skills/dsh-cloud-cost-optimization/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-cloud-cost-optimization
 */
...
const PROVIDER_NAME = 'dsh-cloud-cost-optimization'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-cloud-cost-optimization'
