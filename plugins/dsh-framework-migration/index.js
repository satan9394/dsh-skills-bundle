/**
 * dsh-framework-migration bundle entry: registers the packaged
 * `skills/dsh-framework-migration/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-framework-migration
 */
...
const PROVIDER_NAME = 'dsh-framework-migration'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-framework-migration'
