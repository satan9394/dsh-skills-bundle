/**
 * dsh-observability-tools bundle entry: registers the packaged
 * `skills/dsh-observability-tools/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-observability-tools
 */
...
const PROVIDER_NAME = 'dsh-observability-tools'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-observability-tools'
