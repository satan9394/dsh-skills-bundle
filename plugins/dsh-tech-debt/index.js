/**
 * dsh-tech-debt bundle entry: registers the packaged
 * `skills/dsh-tech-debt/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-tech-debt
 */
...
const PROVIDER_NAME = 'dsh-tech-debt'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-tech-debt'
