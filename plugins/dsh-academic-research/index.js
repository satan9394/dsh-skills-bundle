/**
 * dsh-academic-research bundle entry: registers the packaged
 * `skills/dsh-academic-research/SKILL.md` bundle on `ctx.skills`.
...
const PROVIDER_NAME = 'dsh-academic-research'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-academic-research'
