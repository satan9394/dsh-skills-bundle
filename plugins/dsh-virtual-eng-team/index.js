/**
 * dsh-virtual-eng-team bundle entry: registers the packaged
 * `skills/dsh-virtual-eng-team/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-virtual-eng-team
 */
...
const PROVIDER_NAME = 'dsh-virtual-eng-team'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-virtual-eng-team'
