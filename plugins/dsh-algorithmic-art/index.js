/**
 * dsh-algorithmic-art bundle entry: registers the packaged
 * `skills/dsh-algorithmic-art/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-algorithmic-art
 */
...
const PROVIDER_NAME = 'dsh-algorithmic-art'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-algorithmic-art'
