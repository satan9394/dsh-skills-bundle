/**
 * dsh-knowledge-brain bundle entry: registers the packaged
 * `skills/dsh-knowledge-brain/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-knowledge-brain
 */
...
const PROVIDER_NAME = 'dsh-knowledge-brain'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-knowledge-brain'
