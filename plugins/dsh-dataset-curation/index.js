/**
 * dsh-dataset-curation bundle entry: registers the packaged
 * `skills/dsh-dataset-curation/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-dataset-curation
 */
...
const PROVIDER_NAME = 'dsh-dataset-curation'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-dataset-curation'
