/**
 * dsh-a11y-audit bundle entry: registers the packaged
 * `skills/dsh-a11y-audit/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-a11y-audit
 */
...
const PROVIDER_NAME = 'dsh-a11y-audit'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-a11y-audit'
