/**
 * dsh-diagram-design bundle entry: registers the packaged
 * `skills/dsh-diagram-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-diagram-design
 */
...
const PROVIDER_NAME = 'dsh-diagram-design'
