/**
 * dsh-javascript-typescript bundle entry: registers the packaged
 * `skills/dsh-javascript-typescript/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-javascript-typescript
 */
...
const PROVIDER_NAME = 'dsh-javascript-typescript'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-javascript-typescript'
