/**
 * dsh-microservices bundle entry: registers the packaged
 * `skills/dsh-microservices/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-microservices
 */
...
const PROVIDER_NAME = 'dsh-microservices'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-microservices'
