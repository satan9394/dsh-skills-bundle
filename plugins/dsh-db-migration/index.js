/**
 * dsh-db-migration bundle entry: registers the packaged
 * `skills/dsh-db-migration/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-db-migration
 */
...
const PROVIDER_NAME = 'dsh-db-migration'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-db-migration'
