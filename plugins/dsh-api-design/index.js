/**
 * dsh-api-design bundle entry: registers the packaged
 * `skills/dsh-api-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-api-design
 */
...
const PROVIDER_NAME = 'dsh-api-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-api-design'
