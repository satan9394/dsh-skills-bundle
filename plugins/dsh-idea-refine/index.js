/**
 * dsh-idea-refine bundle entry: registers the packaged
 * `skills/dsh-idea-refine/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-idea-refine
 */
...
const PROVIDER_NAME = 'dsh-idea-refine'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-idea-refine'
