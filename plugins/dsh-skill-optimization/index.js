/**
 * dsh-skill-optimization bundle entry: registers the packaged
 * `skills/dsh-skill-optimization/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-skill-optimization
 */
...
const PROVIDER_NAME = 'dsh-skill-optimization'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-skill-optimization'
