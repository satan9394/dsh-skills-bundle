/**
 * dsh-architecture bundle entry: registers the packaged
 * `skills/dsh-architecture/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-architecture
 */
...
const PROVIDER_NAME = 'dsh-architecture'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-architecture'
