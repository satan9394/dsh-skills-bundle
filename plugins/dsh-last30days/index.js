/**
 * dsh-last30days bundle entry: registers the packaged
 * `skills/dsh-last30days/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-last30days
 */
...
const PROVIDER_NAME = 'dsh-last30days'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-last30days'
