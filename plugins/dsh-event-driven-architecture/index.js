/**
 * dsh-event-driven-architecture bundle entry: registers the packaged
 * `skills/dsh-event-driven-architecture/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-event-driven-architecture
 */
...
const PROVIDER_NAME = 'dsh-event-driven-architecture'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-event-driven-architecture'
