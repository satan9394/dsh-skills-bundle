/**
 * dsh-discernment-nudge bundle entry: registers the packaged
 * `skills/dsh-discernment-nudge/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-discernment-nudge
 */
...
const PROVIDER_NAME = 'dsh-discernment-nudge'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-discernment-nudge'
