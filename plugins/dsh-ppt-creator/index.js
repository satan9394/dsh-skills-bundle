/**
 * dsh-ppt-creator bundle entry: registers the packaged
 * `skills/ppt-creator/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-ppt-creator
 */
...
const PROVIDER_NAME = 'dsh-ppt-creator'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-ppt-creator'
