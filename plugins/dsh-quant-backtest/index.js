/**
 * dsh-quant-backtest bundle entry: registers the packaged
 * `skills/dsh-quant-backtest/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-quant-backtest
 */
...
const PROVIDER_NAME = 'dsh-quant-backtest'
