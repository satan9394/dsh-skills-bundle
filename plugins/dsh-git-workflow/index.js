/**
 * dsh-git-workflow bundle entry: registers the packaged
 * `skills/dsh-git-workflow/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-git-workflow
 */
...
const PROVIDER_NAME = 'dsh-git-workflow'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-git-workflow'
