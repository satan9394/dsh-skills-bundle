/**
 * dsh-signed-audit-trails bundle entry: registers the packaged
 * `skills/dsh-signed-audit-trails/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-signed-audit-trails
 */
...
const PROVIDER_NAME = 'dsh-signed-audit-trails'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-signed-audit-trails'
