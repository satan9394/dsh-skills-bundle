/**
 * dsh-social-publishing bundle entry: registers the packaged
 * `skills/dsh-social-publishing/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-social-publishing
 */
...
const PROVIDER_NAME = 'dsh-social-publishing'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-social-publishing'
