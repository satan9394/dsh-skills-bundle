/**
 * dsh-distributed-debugging bundle entry: registers the packaged
 * `skills/dsh-distributed-debugging/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-distributed-debugging
 */
...
const PROVIDER_NAME = 'dsh-distributed-debugging'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-distributed-debugging'
