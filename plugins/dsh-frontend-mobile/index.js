/**
 * dsh-frontend-mobile bundle entry: registers the packaged
 * `skills/dsh-frontend-mobile/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-frontend-mobile
 */
...
const PROVIDER_NAME = 'dsh-frontend-mobile'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-frontend-mobile'
