/**
 * dsh-live-docs bundle entry: registers the packaged
 * `skills/dsh-live-docs/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-live-docs
 */
...
const PROVIDER_NAME = 'dsh-live-docs'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-live-docs'
