/**
 * dsh-hallmark-design bundle entry: registers the packaged
 * `skills/dsh-hallmark-design/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-hallmark-design
 */
...
const PROVIDER_NAME = 'dsh-hallmark-design'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-hallmark-design'
