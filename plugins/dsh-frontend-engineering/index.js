/**
 * dsh-frontend-engineering bundle entry: registers the packaged
 * `skills/dsh-frontend-engineering/SKILL.md` bundle on `ctx.skills`.
 * @module dsh-frontend-engineering
 */
...
const PROVIDER_NAME = 'dsh-frontend-engineering'
const SKILLS_ROOT = fileURLToPath(new URL('./skills/', import.meta.url))

export const name = 'dsh-frontend-engineering'
